...
public class ArquivoRUIM {
    ...
    public ArquivoRUIM(Integer id, String nome, byte[] dados, Path base) {
        this.id = id;
        this.nome = nome + id;
        this.dados = dados;
        basePath = base;
    ...
    private CaminhoArquivo montarCaminhoDoArquivo() {
        ...
        //            diretorio = basePath.toFile().getPath()+"/"+ BASE_DIRETORIO_ARQUIVOS + "/1";
        //        } else {
        //            int i = 2;
        ...
        //                    diretorio = basePath.toFile().getPath()+"/"+BASE_DIRETORIO_ARQUIVOS + "/"+i;
        //                    achouDiretorio = true;
        //                }
        //                i++;
        //            }
        //        }
        //        return new CaminhoArquivo(Paths.get(diretorio), Paths.get(diretorio + "/" + nome));
